...
RLPEncode.prototype.onExecute = function () {
  ...
  if (
    typeof this.getInputData(0) != "undefined" &&
    this.getInputData(0) != null
  ) {
    dataArray.push(this.getInputData(0));
  }

  if (
    typeof this.getInputData(1) != "undefined" &&
  ...
  if (
    typeof this.getInputData(2) != "undefined" &&
    this.getInputData(2) != null
  ) {
    dataArray.push(this.getInputData(2));
  }

  if (
    typeof this.getInputData(3) != "undefined" &&
    this.getInputData(3) != null
  ) {
    dataArray.push(this.getInputData(3));
  }

  if (
    typeof this.getInputData(4) != "undefined" &&
    this.getInputData(4) != null
  ) {
    dataArray.push(this.getInputData(4));
  }

  if (
    typeof this.getInputData(5) != "undefined" &&
    this.getInputData(5) != null
  ) {
